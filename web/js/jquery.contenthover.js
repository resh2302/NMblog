		...
		init : function(options) {
			...
			return this.each(function(){
				...
				if ($data.length) {
					...
					var $ch_wrapper = $('<div>').addClass('ch_element').addClass(settings.wrapper_class).css({ 'width':'172px', 'height': '182px', 'position':'relative', 'overflow':'hidden' }).insertAfter($this);
